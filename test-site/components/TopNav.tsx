...
const CRM_DASHBOARD_URL = process.env.NEXT_PUBLIC_CRM_DASHBOARD_URL ?? "http://localhost:3002";
...
/**
 * AI Counsellor (this app) and CRM Dashboard are separate deployments (the
 * CRM is an internal, login-gated staff tool — never part of the client's
 * public site), so this is a cross-app nav, not client-side routing.
 */
